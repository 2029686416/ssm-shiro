...
public class Page<T> extends RowBounds {
    ...
    protected List<Map<String,Object>> mrows=new ArrayList<Map<String,Object>>();	
    /**
     * 总条数
     */
    protected int total;
    ...
    public List<Map<String, Object>> getMrows() {
		return mrows;
	}

	public void setMrows(List<Map<String, Object>> mrows) {
		this.mrows = mrows;
	}
